      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="mt-4 space-y-4">
            <li><Link to="/treatments" className="text-base text-gray-600 hover:text-gray-900">Laser Treatments</Link></li>
            <li><Link to="/treatments" className="text-base text-gray-600 hover:text-gray-900">Skin Care</Link></li>
            <li><Link to="/treatments" className="text-base text-gray-600 hover:text-gray-900">Hair Restoration</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="mt-4 space-y-4">
            ...
            <li><Link to="/results" className="text-base text-gray-600 hover:text-gray-900">Results</Link></li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-4">
            <li><Link to="/after-care" className="text-base text-gray-600 hover:text-gray-900">After Care</Link></li>
