      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-center sm:text-left">
        <div className="col-span-1">
          ...
          <ul className="mt-4 space-y-4 flex flex-col items-center sm:items-start">
            <li><Link to="/treatments" className="text-base text-gray-600 hover:text-[#C09A50] transition-colors">Laser Treatments</Link></li>
            <li><Link to="/treatments" className="text-base text-gray-600 hover:text-[#C09A50] transition-colors">Skin Care</Link></li>
            <li><Link to="/treatments" className="text-base text-gray-600 hover:text-[#C09A50] transition-colors">Hair Restoration</Link></li>
          </ul>
        </div>
        <div className="col-span-1">
        ...
        <div className="col-span-2 sm:col-span-1 flex flex-col items-center sm:items-start mt-4 sm:mt-0">
          ...
          <ul className="mt-4 space-y-4 flex flex-col items-center sm:items-start">
            {/* <li><Link to="/after-care" className="text-base text-gray-600 hover:text-[#C09A50] transition-colors">After Care</Link></li> */}
            <li><Link to="/contact" className="text-base text-gray-600 hover:text-[#C09A50] transition-colors">Contact</Link></li>
            <li>
              <Link
                to="/privacy-policy"
